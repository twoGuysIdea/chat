package com.chat.springboot.config;
...
public class ElasticSearchConfig {
	...
	public TransportClient client() throws UnknownHostException {
		...
		try {
			...
			TransportAddress transportAddress = new TransportAddress(InetAddress.getByName("192.168.31.105"), 9300);
			transportClient.addTransportAddresses(transportAddress);
		} catch (Exception e) {
			System.out.println("初始化elastic。。失败");
		}
